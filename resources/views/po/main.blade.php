                            ...
                            <div id="text">
                                <form>
                                    <fieldset id="sexFieldset">
                                        ...
                                        <div class="textalign">
                                            <input type="radio" name="one" id="sex1" value="1"><label class="radio-inline col-md-6 col-xs-6" for="sex1"><img id="male" src="image/m.jpg"/></label>
                                            <input type="radio" name="one" id="sex2" value="2"><label class="radio-inline col-md-6 col-xs-6" for="sex2"><img id="female" src="image/f.jpg"/></label>
                                        </div>
                                    </fieldset>
                                </form>
                            </div>
