    ...
    <div class="panel" id="vrBlock">
        <div class="row">
            ...
            <div class="col-xs-12 col-md-10">
                ...
                <div>
                    <a target="_blank" class="nameCompany-myVacancy"
                       href="/company/{{$company->id}}">{{$company->company_name}}</a>
                </div>
                ...
                <div>
                    <p class="cityTime-myVacancy">
                        @foreach($cities->get() as $city)
                            <a class="city-myVacancy"
                               href="javascript:submit('selectCity', '{{$city->id}}')">{{$city->name}} </a>
                        @endforeach
                        <span id="yellowCircle-myVacancy">&bull;</span> <span
                                id="updateDate">{{ date('j m Y', strtotime($vacancy->updated_at))}}</span>
                    </p>
                </div>
            </div>
        </div>
