...
return [
	...
	*/
	...
	'custom' => [
        ...
        'telephone' => [
            'min' => 'Поле повинно містити мінімум 5 символів!',
            'max' => 'Поле повинно містити максимум 35 символів!',
        ],
        'position' => [
            'required' => 'Поле обов\'язкове для заповнення!',
		...
		'loadResume'=> [
			'mimes' =>' Будь ласка, завантажте файл в форматі doc, docx, odt, rtf, txt або pdf.',
		],
		'Link'=>[
		...
		'name' => [
			...
			'max'=>'Поле повинно містити максимум 30 символів!',
			'regex'=>'Поле може містити лише літери,цифри,знак підкресловання,дефіс та апостроф!',
			],
	],
